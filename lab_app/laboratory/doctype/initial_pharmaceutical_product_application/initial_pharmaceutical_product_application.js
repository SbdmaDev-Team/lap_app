...
frappe.ui.form.on('Initial Pharmaceutical Product Application', {
    ...
    // Custom buttons
        refresh: function(frm) {
            ...
            var new_application = frappe.model.get_new_doc('Pharmaceutical Product Analysis Application');          
            new_application.ref_name = frm.doc.name;
            
            frappe.set_route('Form', 'pharmaceutical-product-analysis-application',new_application.name);
